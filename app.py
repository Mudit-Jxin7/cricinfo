...
@app.route("/")
def index():
    """Render the match input form. Default event is IPL 2026."""
    events = db.get_all_events()
    ipl_2026 = db.get_event_by_name("IPL 2026")
    default_event_id = ipl_2026["id"] if ipl_2026 else (events[0]["id"] if events else 1)
